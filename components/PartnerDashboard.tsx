   ...
   const clients: PartnerClient[] = [
      {
         ...
         overallHealth: 45, criticalPillar: 'Money', lastAssessedDate: 'Oct 24', status: 'needs_call',
         pillarScores: { operations: 60, money: 12, market: 50, innovation: 70, leadership: 40, risk: 30, people: 50 },
         drivers: { no_cash_buffer: true, overdue_invoices: 'high' }
      },
      {
         id: 'c2', name: 'TechFlow', company: 'TechFlow Inc', industry: 'SaaS', country: 'US',
         overallHealth: 82, criticalPillar: 'People', lastAssessedDate: 'Oct 20', status: 'stable',
         pillarScores: { operations: 85, money: 90, market: 80, innovation: 85, leadership: 75, risk: 80, people: 65 },
         drivers: {}
      },
      {
         id: 'c3', name: 'Apex Retail', company: 'Apex Retail Group', industry: 'Retail', country: 'KE',
         overallHealth: 60, criticalPillar: 'Market', lastAssessedDate: 'Oct 15', status: 'active',
         pillarScores: { operations: 70, money: 65, market: 25, innovation: 60, leadership: 55, risk: 70, people: 60 },
         drivers: { no_followup_system: true }
      },
      {
         id: 'c4', name: 'Green Agro', company: 'Green Agro Co', industry: 'Agriculture', country: 'NG',
         overallHealth: 30, criticalPillar: 'Risk', lastAssessedDate: 'Oct 10', status: 'needs_call',
         pillarScores: { operations: 40, money: 35, market: 30, innovation: 40, leadership: 30, risk: 15, people: 20 },
         drivers: { no_contracts: true, no_sops: true }
      },
      {
         id: 'c5', name: 'Swift Movers', company: 'Swift Movers', industry: 'Logistics', country: 'UG',
         overallHealth: 55, criticalPillar: 'Operations', lastAssessedDate: 'Oct 28', status: 'active',
         pillarScores: { operations: 28, money: 60, market: 55, innovation: 60, leadership: 50, risk: 50, people: 55 },
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm p-6">
               <div className="overflow-x-auto">
                  <div className="grid grid-cols-8 gap-1 min-w-[800px]">
                     ...
                     {['Operations', 'Money', 'Market', 'Innovation', 'Leadership', 'Risk', 'People'].map(p => (
                     ...
                     {clients.map(client => (
                        <React.Fragment key={client.id}>
                           ...
                           {['operations', 'money', 'market', 'innovation', 'leadership', 'risk', 'people'].map(key => {
                              // @ts-ignore
