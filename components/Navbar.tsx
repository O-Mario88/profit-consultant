...
import { Globe, Menu, Search, LogOut, X, LayoutDashboard } from 'lucide-react';
...
const Navbar: React.FC<NavbarProps> = ({ currentView, setView, user, onLogout }) => {
   const { locale, setRegion } = useLocalization();
            ...
            <div className="flex justify-between items-center gap-4">
               ...
               <div className="flex items-center gap-6">
                  ...
                  <div className="hidden md:block">
                     <button
                        className="flex items-center gap-2 text-sm font-medium py-2 px-4 rounded-full transition-all border bg-primary text-on-primary border-transparent hover:bg-primary/90"
                  ...
                  <div className="flex-1 overflow-y-auto py-2">
                     <div className="px-3 space-y-1">
                        ...
                        {[
                           ...
                           { id: 'diagnostic', label: 'Start Scan', icon: Search, show: true },
