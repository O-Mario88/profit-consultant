...
export const SMALL_RUMINANTS_ACTIONS: ActionDefinition[] = [
    // P1 Market
    {
        ...
        signal_tags: ['pricing_method', 'pricing_power'],
        days: 7,
        effort: 'S',
        impact_score: 9,
    ...
    },
    {
        ...
        industry: 'small_ruminants',
        line_type: ['Sheep farming', 'Goat farming'],
        signal_tags: ['waste_reduction', 'unit_economics'],
        days: 7,
        effort: 'S',
        impact_score: 8,
    ...
    // P4 Health
    {
        ...
        industry: 'small_ruminants',
        line_type: ['Sheep farming', 'Goat farming'],
        signal_tags: ['early_detection', 'health_records'],
        days: 7,
        effort: 'S',
        impact_score: 9,
    ...
    // P5 Operations
    {
        ...
        industry: 'small_ruminants',
        line_type: ['Sheep farming', 'Goat farming'],
        signal_tags: ['security_routine', 'predator_control'],
        days: 7,
        effort: 'S',
        impact_score: 8,
    ...
    // P6 People
    {
        ...
        industry: 'small_ruminants',
        line_type: ['Sheep farming', 'Goat farming'],
        signal_tags: ['process_consistency', 'accountability'],
        days: 7,
        effort: 'S',
        impact_score: 9,
    ...
    // P7 Finance
    {
        ...
        industry: 'small_ruminants',
        line_type: ['Sheep farming', 'Goat farming'],
        signal_tags: ['financial_separation', 'cash_planning'],
        days: 7,
        effort: 'S',
        impact_score: 10,
    ...
    // P8 Records
    {
        ...
        industry: 'small_ruminants',
        line_type: ['Sheep farming', 'Goat farming'],
        signal_tags: ['record_habit', 'data_quality_ci'],
        days: 7,
        effort: 'S',
        impact_score: 9,
